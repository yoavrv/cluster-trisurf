...
ts_poly	*init_poly(ts_idx n, ts_vertex *grafted_vtx){
...
ts_bool poly_initial_distribution(ts_poly_list *poly_list, ts_idx i, ts_vesicle *vesicle){
...
ts_poly_list *init_poly_list(ts_idx n_poly, ts_idx n_mono, ts_vertex_list *vlist, ts_vesicle *vesicle){
...
ts_poly *remove_poly_with_index(ts_poly_list *poly_list, ts_idx idx){
    ts_idx i;
...
ts_bool remove_random_polymeres(ts_poly_list *poly_list, ts_idx number){
...
ts_poly_list *init_empty_poly_list(ts_idx n_poly, ts_idx n_mono){
    ts_poly_list *poly_list=(ts_poly_list *)calloc(1,sizeof(ts_poly_list));
    poly_list->poly=(ts_poly **)calloc(n_poly,sizeof(ts_poly *));
    ts_idx i;
    for (i=0; i<n_poly;i++){
